        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WordCollections_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WordDictionaries_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "WordToWordDictionary",
                columns: table => new
                {
                    WordId = table.Column<int>(type: "integer", nullable: false),
                    WordDictionaryId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WordToWordDictionary", x => new { x.WordId, x.WordDictionaryId });
                    table.ForeignKey(
                        name: "FK_WordToWordDictionary_WordDictionaries_WordDictionaryId",
                        column: x => x.WordDictionaryId,
                        principalTable: "WordDictionaries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WordToWordDictionary_Words_WordId",
                        column: x => x.WordId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WordToWordDictionary_WordDictionaryId",
                table: "WordToWordDictionary",
